      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <View style={styles.resultsCard}>
            <View style={styles.resultRow}>
              ...
              <Text style={styles.resultValue}>{results.totalLoadWithSafety.toFixed(2)} kW</Text>
            </View>
            <View style={styles.resultRow}>
            ...
            <View style={styles.resultRow}>
              <Text style={styles.resultLabel}>SHR (Sensible Heat Ratio):</Text>
              <Text style={styles.resultValue}>{(results.loadSummary.SHR * 100).toFixed(1)}%</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakdownCard}>
            ...
            <View style={styles.breakdownRow}>
              ...
              <Text style={styles.breakdownValue}>{results.breakdown.doorOpening.total.toFixed(2)} kW</Text>
            </View>
            <View style={[styles.breakdownRow, styles.totalBreakdownRow]}>
              <Text style={styles.totalBreakdownLabel}>Total Before Safety</Text>
              <Text style={styles.totalBreakdownValue}>{results.totalLoad.toFixed(2)} kW</Text>
            </View>
            <View style={styles.breakdownRow}>
              <Text style={styles.breakdownLabel}>Safety Factor (10%)</Text>
              <Text style={styles.breakdownValue}>{(results.totalLoadWithSafety - results.totalLoad).toFixed(2)} kW</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.equipmentCard}>
            <View style={styles.equipmentRow}>
              <Text style={styles.equipmentLabel}>Total Air Flow:</Text>
              <Text style={styles.equipmentValue}>{results.conditions.totalAirFlow.toFixed(0)} CFM</Text>
            </View>
            <View style={styles.equipmentRow}>
              <Text style={styles.equipmentLabel}>Fan Motor Load:</Text>
              <Text style={styles.equipmentValue}>{results.breakdown.internal.fanMotor.toFixed(2)} kW</Text>
            </View>
            <View style={styles.equipmentRow}>
              <Text style={styles.equipmentLabel}>Heater Load:</Text>
              <Text style={styles.equipmentValue}>
                {(results.breakdown.internal.doorHeaters + results.breakdown.internal.trayHeaters + results.breakdown.internal.peripheralHeaters).toFixed(2)} kW
              </Text>
            </View>
            <View style={styles.equipmentRow}>
              <Text style={styles.equipmentLabel}>Room Humidity:</Text>
              <Text style={styles.equipmentValue}>{results.conditions.humidity}% RH</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <SharePDFButton 
            ...
            calculationType="freezer"
            title="Freezer Load Calculation"
          />
        </View>
      </ScrollView>
    </LinearGradient>
